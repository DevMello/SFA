...
public class ModConfig {
  ...
  public static final String DEFAULT_STREAM_TOKEN = "";
  ...
  public ModConfig() {
    ...
    this.streamToken = DEFAULT_STREAM_TOKEN;
  }
    ...
    try {
      ...
      if (!jsonStr. equals("")) {
        ...
        this.prefix = jsonObject.has("prefix")
                ...
                : DEFAULT_PREFIX;
        this.oauthKey = jsonObject.has("streamToken")
                ? jsonObject.getAsJsonPrimitive("streamToken").getAsString()
                : DEFAULT_OAUTH_KEY;
