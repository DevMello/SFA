package cf.devmello.sfa.config;
  ...
  public ConfigScreenFactory<?> getModConfigScreenFactory() {
    return (ConfigScreenFactory<Screen>) screen -> {
      ...
      credentialsCategory.addEntry(entryBuilder
              ...
              .build());
      credentialsCategory.addEntry(entryBuilder
              .startStrField(Text.translatable("config.twitchchat.credentials.StreamToken"), ModConfig.getConfig().getOauthKey())
              .setSaveConsumer((s -> ModConfig.getConfig().setStreamToken(s)))
              .setTooltip(Text.translatable("config.twitchchat.credentials.StreamToken.tooltip"))
              .setDefaultValue(ModConfig.DEFAULT_STREAM_TOKEN)
              .build());
